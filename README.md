...
| [Love Swipe](https://github.com/oktayshakirov/couples-card-game)    | React Native, Expo, TypeScript                         | Couples truth-or-dare app with smooth swipe gameplay, turn-based flow and live player statistics.                         |
...
| [TinnitusHelp App](https://github.com/oktayshakirov/tinnitus-app)   | React Native, Expo, Firebase                           | Tinnitus-focused mobile app with educational articles, calming soundscapes, mindfulness tools and push notifications.     |
...
| [TinnitusHelp](https://github.com/oktayshakirov/tinnitus-blog)      | Next.js, TypeScript, Material UI                       | Tinnitus-focused website with in-depth articles, practical guidance and therapeutic audio content in a responsive layout. |
| [Crypto Wiki](https://github.com/oktayshakirov/crypto-wiki)         | MDX, Content Collections, Web Platform                 | Educational crypto website focused on readable guides, crypto exchanges reviews and crypto ogs biographies.               |
...
| [All Projects](https://github.com/oktayshakirov?tab=repositories)   |                                                        | Browse the complete list of repositories and latest updates.                                                              |
